 ...
 * @return {this} this
 */
three.EventDispatcher.prototype.emit = function (type, event) {
  event.type = type;
 ...
 * @return {this} this
 */
three.Object3D.prototype.emit = function (type, event) {
  event.type = type;
  this.dispatchEvent(event);
  return this;
};
...
var InteractionManager = function (_EventDispatcher) {
  ...
  function InteractionManager(renderer, scene, camera, options) {
    ...
    /**
     * Internal cached let. TODO: should remove
     *
     * @private
     * @member {PIXI.Point}
     */
  ...
  createClass(InteractionManager, [{
    ...
    value: function processInteractive(interactionEvent, displayObject, func, hitTest, interactive) {
      ...
      // if the displayobject has a hitArea, then it does not need to hitTest children. TODO: there should not check for threejs
